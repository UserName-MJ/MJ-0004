...
public class RedisClientTest extends TestCase {
	...
	private static Jedis getJedis() {
		Jedis jedis = new Jedis("172.16.143.99", 6379);
		return jedis;
	}
	@Test
	public void test_sdsd(){
		Jedis jedis = getJedis();
	   Map<String, String> hgetAll = jedis.hgetAll("10USER");
	   Set<String> set = hgetAll.keySet();
	   for (String str : set) {
		   //jedis.hdel("10USER", str);
	...
	public void test_list_set() {
		...
		System.out.println("lrem lrange(0,-1) = " + j.lrange(key, 0, -1)); // [Collection,
																			// Vector,
																			// Map,
																			// List]
